...
<body class="simple-page bg-danger">
	<div id="back-to-home">
	...
	<div class="simple-page-wrap">
		<div class="simple-page-logo animated swing">
			...
			<span style="color: white"><i class="fa fa-sign-in"></i></span>
			<span style="color: white">Doctor Appointment Management System</span>

		</div><!-- logo -->
		<div class="simple-page-form animated flipInY" id="login-form">
			<h4 class="form-title m-b-xl text-center text-red">Sign In
				<!-- With Your DAMS Account -->
			</h4>
			<form method="post" name="login">
				...
				<input type="submit" class="btn  btn-bg-red" name="login" value="Sign IN">
			</form>
			<hr />
			<a href="signup.php" class="text-red">Signup/Registration</a>
		</div><!-- #login-form -->
