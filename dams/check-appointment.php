                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12 mx-auto">
                        <div class="booking-form">
                            ...
                            <h2 class="text-center mb-lg-3 mb-2 text-danger">Search Appointment History by Appointment Number/Name/Mobile No</h2>
                            ...
                            <form role="form" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-6 mx-auto">
                                        <button type="submit" class="form-control bg-danger" name="search" id="submit-button">Check</button>
                                    </div>
                                </div>
                            </form>
