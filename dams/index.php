                        ...
                        <div id="myCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="images/slider/doc-1.jpeg" class="img-fluid" alt="">
                                </div>

                                <div class="carousel-item">
                                    <img src="images/slider/doc-2.jpg" class="img-fluid" alt="">
                                </div>

                                <div class="carousel-item">
                                    <img src="images/slider/doc-3.jpg" class="img-fluid" alt="">
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-5 col-12 mx-auto">
                        <div class="featured-circle bg-white shadow-lg d-flex justify-content-center align-items-center">
                            <p class="featured-text text-danger"><span class="featured-number text-info">8</span> Years<br> of Experiences</p>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-12 mx-auto">
                        <div class="booking-form">
                            ...
                            <h2 class="text-center text-danger mb-lg-3 mb-2">Book an appointment</h2>
                            ...
                            <form role="form" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-6 mx-auto">
                                        <button type="submit" class="form-control bg-danger" name="submit" id="submit-button">Book Now</button>
                                    </div>
                                </div>
                            </form>
